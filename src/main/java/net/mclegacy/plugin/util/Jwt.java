...
public final class Jwt
{
    ...
    public static String createToken(long expiration, String... claims) {
        ...
        builder.withIssuer("OldSchoolMinecraft");
    ...
    private static String getHmacKey() {
        ...
        if (!hmacFile.exists())
        {
            ...
            log.warning("HS512 JWT key generated & written to disk");
            return b64key;
        }

        if (!hmacFile.canRead() || !hmacFile.exists()) {
            log.severe("There was an issue loading the HMAC file!");
            System.exit(-1);
        }
